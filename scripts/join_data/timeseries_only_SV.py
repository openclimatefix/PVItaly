...
pv_filename_new = "./data/SV_Italy_PV_timeseries_batch.hdf"
...
pv_data_belluno_1['energy_gen_Wh'] = pv_data_belluno_1['Energia Elettrica ATTIVA prodotta fotovoltaico (kWh)'] * 1000
...
pv_data_bari_2 = pv_data_2[['Energia Elettrica Prodotta da Impianto Fotovoltaico CONVITTO ALLIEVI (kWh)']]

pv_data_bari_1['energy_gen_Wh'] = pv_data_bari_1['Energia Elettrica Prodotta da Impianto Fotovoltaico ASCLEPIOS (kWh)'] * 1000
pv_data_bari_2['energy_gen_Wh'] = pv_data_bari_2['Energia Elettrica Prodotta da Impianto Fotovoltaico CONVITTO ALLIEVI (kWh)'] * 1000
...
pv_data_forscari_1['energy_gen_Wh'] = pv_data_forscari_1['Energia Elettrica Fotovoltaico Edificio Beta (kWh)'] * 1000
...
for key, value in data.items():
    ...
    if key == '4':
        value = data[key]
        data[key] = value[(pd.to_datetime(value.index) < datetime(2021,6,9))
