...
for i in range(0, 4):
    ...
    trace = go.Scatter(x=tmp["step"], y=tmp["abs_err"], name=system_names[i],line=dict(color=colour_hex[i]))
    traces.append(trace)
...
datetimes = [datetime(2022,6,5,11,30),datetime(2022,5,20,11),datetime(2022,1,5,12),datetime(2022,1,4,12),datetime(2022,1,9,12)]
