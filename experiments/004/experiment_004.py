...
nwp_pv_data_pipeline = nwp_pv_datapipe("experiments/004/exp_004.yaml")
nwp_pv_data_pipeline_validation = nwp_pv_datapipe("experiments/004/exp_004_validation.yaml", tag='validation')
#
